...
/*-- CONFIGURATION du message, remplir ici la valeur EN HEXADECIMAL --*/
...
void setup() {
	...
	if (kim.KIM_isKIM2() == true) // Vérifier la présence du module KIM 1 puis du KIM 2 et ces identifiants
...
void loop() { // Boucle controlant l'envoi du message donc si tous les paramètres sont vérifiés et remplis alors le message est envoye
